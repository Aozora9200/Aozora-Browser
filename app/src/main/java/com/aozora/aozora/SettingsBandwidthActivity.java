...
public class SettingsBandwidthActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        applySavedTheme();
        setContentView(R.layout.settings_bandwidth);
        ...
        if (savedInstanceState == null) {
            getFragmentManager().beginTransaction()
                    .replace(R.id.settings_browser_fragment, new SettingsBandwidthFragment())
                    .commit();
        }
        // Action Bar が表示されているか確認
        if (getActionBar() != null) {
